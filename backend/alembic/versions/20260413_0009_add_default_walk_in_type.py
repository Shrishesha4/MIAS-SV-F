"""add default walk in type to insurance categories
...
def upgrade() -> None:
    ...
    if 'insurance_categories' in tables:
        ...
        if 'default_walk_in_type' not in columns:
            op.add_column('insurance_categories', 
                sa.Column('default_walk_in_type', sa.String(), nullable=False, server_default='NO_WALK_IN'))
