...
export const adminPageNavItems = [
	...
	{ id: 'ai', label: 'System Config', href: '/admin/ai', icon: BrainCircuit },
	...
	{ id: 'charges', label: 'Charge Master (Rates)', href: '/admin/charges', icon: IndianRupee },
	{ id: 'programmes', label: 'Academics', href: '/admin/programmes', icon: GraduationCap },
	{ id: 'forms', label: 'Dynamic Form Builder', href: '/admin/forms', icon: FileText },
