import { BarChart3, BrainCircuit, Building2, FlaskConical, GraduationCap, Stethoscope, Users, IndianRupee, FileText, Heart, Cpu } from 'lucide-svelte';
...
export const adminPageNavItems = [
	...
	{ id: 'ot', label: 'Operation Theaters', href: '/admin/ot', icon: Cpu },
